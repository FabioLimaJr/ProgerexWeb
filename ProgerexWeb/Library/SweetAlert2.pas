...
interface
  ...
  //função para trabalhar as bibliotecas online
  Function Lib_CSS_SweetAlert2 :String;
  Function Lib_JS_SweetAlert2 :String;


  //Função para utilizar os arquivos offline
  Function GetLibCssSweetAlert2: String;
  Function GetJsSweetAlert2: String;
